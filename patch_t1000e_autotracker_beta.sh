...
#   - Every 4 hours, check for significant movement from the last advertised position.
#   - Only advertise when significant movement has occurred.
...
method = '''// HTR Auto Tracker BETA: maintain a useful last-known GPS location
